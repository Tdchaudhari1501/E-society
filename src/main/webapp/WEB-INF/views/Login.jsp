            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <a href="index.html" class="logo d-flex align-items-center w-auto">
                  ...
                  <span class="d-none d-lg-block">eSociety</span>
                </a>
              </div><!-- End Logo -->
                  ...
                  <form class="row g-3 needs-validation" action="authenticate" method="post" novalidate>
                    ...
                    <div class="col-12">
                      ...
                      <div class="input-group has-validation">
                        ...
                        <input type="eamil" name="email" class="form-control" id="loginEmail" required>
                    ...
                    <div class="col-12">
                      ...
                      <p class="small mb-0">Forgot Password ? <a href="forgotpassword">Forgot Password ?</a></p>
