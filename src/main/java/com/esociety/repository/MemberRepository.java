...
public interface MemberRepository extends JpaRepository<MemberEntity, Integer> {
	...
	List<Object[]> getMember(Integer userId);
 	...
 	@Query(value = "select m.membername,m.age,m.profile_photo,m.member_id from member m , users u where u.user_id = m.user_id and m.user_id = :userId",nativeQuery = true)
